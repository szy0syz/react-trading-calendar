...
export const pnlBadgeVariants = cva(
  'inline-flex items-center justify-center w-full px-0.5 sm:px-3 py-0.5 sm:py-1 rounded-md sm:rounded-full text-xs sm:text-sm font-mono font-bold tracking-tighter sm:tracking-normal border shadow-sm transition-colors duration-150 truncate',
  {
    variants: {
      sentiment: {
        positive: '',
