...
export const pnlBadgeVariants = cva(
  'inline-flex items-center justify-center w-full px-1 sm:px-3 py-0.5 sm:py-1 rounded-full text-xs sm:text-sm font-mono font-bold border shadow-sm transition-colors duration-150 truncate',
  {
    variants: {
      sentiment: {
        positive: '',
