...
轻量、高性能、开箱即用的纯渲染交易记录日历组件 (React + Tailwind CSS v4)。支持美股/A股红绿配色切换、明暗主题、移动端响应式布局。
...
- 📦 **轻量打包**：提供 ESM、CJS 及 TypeScript 类型声明，CSS 仅 ~7.5KB (gzipped)。
...
export function App() {
  ...
  const dailyRecords = [
    { date: '2026-08-04', pnl: -4709 },
    { date: '2026-08-05', pnl: 11245 },
    { date: '2026-08-06', pnl: 3523 },
  ];
